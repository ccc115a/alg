...
**領域**：數理邏輯與電腦史 | **年代**：1978 | **相關**：密碼學

---

**趣味點**：密碼學論文過去一直用「A 方與 B 方」描述傳輸，枯燥又容易混淆。RSA 發明者引入了 Alice 與 Bob，後來學者們還加入「竊聽者 Eve」和「壞蛋 Mallory」，硬生生把密碼學論文寫成了八點檔連續劇。

1978 年，[RSA](../演算法/rsa.md) 加密演算法的發明者們（Ron Rivest 等人）在論文中引入了 **Alice（發送者）與 Bob（接收者）**，用來簡化「A 方傳送訊息給 B 方」的枯燥敘述。
...
**延伸閱讀**：[RSA](../演算法/rsa.md)、[Diffie-Hellman 金鑰交換](../演算法/diffie-hellman.md)、[橢圓曲線加密](../演算法/ecc.md)