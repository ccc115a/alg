...
**領域**：數理邏輯與電腦史 | **年代**：1989/1998 | **發明者**：[Leslie Lamport](拜占庭將軍問題.md)

---

**趣味點**：Lamport 把嚴肅的分散式演算法寫成古希臘 Paxos 島議會的故事，審稿人看完氣炸退稿。結果 9 年後大家發現這是分散式共識的唯一解法，期刊編輯只好乖乖跑回去「請神下山」發表這篇奇文。

在[拜占庭將軍問題](拜占庭將軍問題.md)之後，Leslie Lamport 繼續挑戰分散式系統的終極難題：如何在有網路延遲、封包遺失、甚至有惡意節點的情況下，讓多台電腦達成**一致共識**（例如金融轉帳、分散式資料庫的資料同步）。
...
**延伸閱讀**：[拜占庭將軍問題](拜占庭將軍問題.md)、[中本聰與比特幣](比特幣.md)、[乙太網 CSMA/CD](../演算法/csma-cd.md)